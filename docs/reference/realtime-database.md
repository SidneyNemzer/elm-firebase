...
The JavaScript SDK library always sends this as it's first message. The connection is not established until a write or read is requried; the operation is queued while connection, then that message will be sent right after the "client hello".
